...
> For the **CI test strategy and pre-release gating** (the tiered smoke →
> curated subset → real-device ladder), see [`TEST_PLAN.md`](./TEST_PLAN.md).
> This document is the manual how-to for running the upstream suite on a
> physical device.
